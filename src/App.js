  ...
  <Wrapper
    ...
    content={<>
      <Tab content={<>
        ...
        <Button key="clicking" text="click" style={{ color: "purple", border:"none", backgroundColor: "plum", boxShadowColor: "purple" }} fireClick={e=>console.log(e.target)} />
      ...
      <Tab content={<>
        ...
        I bet you’re still using Bootstrap too…" />
        <Input placeholder="try this input" />
        <Button key="clicking" text="click" style={{ color: "purple", backgroundColor: "plum", boxShadowColor: "purple" }} fireClick={e=>console.log(e.target)} />
        <footer>bottom</footer>
      </>}
        openButtonText="see me"
        tabStyle={{alignItems:"center"}}
